...
export enum NotificationType {
  ...
  TRUCK_STOCK_SYNCED = 'TRUCK_STOCK_SYNCED',
  TRUCK_INVENTORY_RESTORED = 'TRUCK_INVENTORY_RESTORED',
  ...
  WARRANTY_RETURN_CREATED = 'WARRANTY_RETURN_CREATED',
  WARRANTY_RETURN_COMPLETED = 'WARRANTY_RETURN_COMPLETED',
}
