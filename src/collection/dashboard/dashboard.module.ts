...
@Module({
  imports: [TypegooseModule.forFeature([Products, WebsiteProducts, Imports, Invoices, Trucks, Customers, DebtPayments, Promotions, Vouchers, PromotionActivations, Users, EmployeeKpis, TruckTransfers, AuditLogs])],
