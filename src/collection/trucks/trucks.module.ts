...
@Module({
  imports: [TypegooseModule.forFeature([Trucks, Products, WebsiteProducts, TruckTransfers, TruckTransferCounters, Users, Invoices, CustomerReturns, TruckStockChecks, TruckInventoryBackups, TruckInventoryBackupCounters, InventoryMovements, Notifications, AuditLogs]), InventoryMovementsModule],
